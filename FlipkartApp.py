...
background-image: url("https://images.pexels.com/photos/4505462/pexels-photo-4505462.jpeg");
...
if data:
    ...
    st.markdown(f'<h1 style="color:#33ff33;font-size:24px;">{"No data available. text”"}</h1>', unsafe_allow_html=True)
